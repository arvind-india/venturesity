...
public class MyDetails extends AppCompatActivity {
    ...
    TextView name,phone,codes,rateus;
                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                Log.d("points",response.getString("points"));
