...
//            Log.d(TAG, "Message data payload: " + remoteMessage.getData());
        ...
        if (remoteMessage.getNotification() != null) {
            ...
            String TrueOrFlase = remoteMessage.getData().get("request");
//            Log.d(TAG, "Message Notification Body: " + msg);
        ...
        if (message != null) {
            ...
            Log.d("amount2", transactionamount);
            ContactModel contactModel = new ContactModel();
            if (sqLiteHelper.checkTransaction(transactionid)) {
                Log.d("here",transactionid);
                ...
                contactModel.setTransectionPhoneNumber(Long.parseLong(phone_number));
                ...
                sqLiteHelper.updateBalance(contactModel.getTransectionPhoneNumber(), Long.parseLong(amount));
