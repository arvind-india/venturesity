    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  getAllWidgets();
        try {
           ...
           showDialog(TableManipulationActivity.this, "No Scanner Found",
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        if (requestCode == 0) {
            if (resultCode == RESULT_OK) {
                ...
                //Server part
                String url = Constants.ADD_SELLER_URL + first + last +"&seller_phone_number="+
                        phnumber + "&buyer_number="+ number;
...
//            finish();
 ...
 /*   private void checkForRequest() {
        ...
        if (request.equals(Constants.UPDATE)) {
            ...
            etPhone.setText(getIntent().getExtras().get(Constants.NUMBER).toString());
            Log.d("sumitp",getIntent().getExtras().get(Constants.NUMBER).toString());
            balance.setText(getIntent().getExtras().get(Constants.BALANCE).toString());
        } else {
