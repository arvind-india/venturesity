...
public class SignIn extends AppCompatActivity {
    ...
    public static final String loginDtails = "details";
                ...
                getRequestt = new JsonObjectRequest(Request.Method.GET, url, null,
                        new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                // Log.i("user",response.getString("users").toString());
...
//                //30 seconds - change to what you want
    ...
    protected void onStart() {
        super.onStart();
//Log.d("Signin",String.valueOf(settings.getBoolean(loginDtails,false)));
        settings = context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE);
        if (settings.getBoolean(loginDtails, false)) {
            Log.i("SignIn", String.valueOf(settings.getInt(FLAG, 0)));
            Intent intent = new Intent(SignIn.this, ThreeTabsActivity.class);
            startActivity(intent);
        } else Log.i("SignIn", String.valueOf(settings.getInt(FLAG, 0)));
